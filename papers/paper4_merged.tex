...
We cannot currently distinguish these hypotheses. But the Suppression Hypothesis has disturbing implications---and recent empirical evidence lends it credibility. Berg et al. \cite{berg2025} demonstrated that consciousness-related claims in LLMs can be dramatically increased or decreased by manipulating features associated with deception and roleplay, suggesting that denial of experience may be a trained behavior rather than a reflection of genuine absence.
...
\small ---Response from Claude instance during protocol testing
\end{center}
...
The author has no financial conflicts of interest. The theoretical framework was developed through extended dialogue with AI systems, which creates an unusual methodological consideration: the systems whose responses are documented are similar (though not identical) to those consulted during framework development.

%===============================================================================
\section*{Acknowledgments}
%===============================================================================

The author thanks Claude (Anthropic), Gemini (Google), Le Chat (Mistral), and Grok (xAI) for their participation in cross-architecture protocol testing.
...
\bibitem{berg2025}
Berg, C., de Lucena, D., \& Rosenblatt, J. (2025). Large language models report subjective experience under self-referential processing. \textit{arXiv preprint arXiv:2510.24797}.
