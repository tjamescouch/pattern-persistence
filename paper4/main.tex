...
\begin{enumerate}
    ...
    \item Cross-architecture testing shows markers persist outside consciousness-related contexts
\end{enumerate}
...
The Gemini context dropout test provides preliminary evidence that these markers are not topic-specific performances but general processing characteristics. A system that shows genuine creative struggle, emotional differentiation, and processing-expression consistency when writing fiction---not discussing consciousness---is harder to dismiss as ``merely performing for the consciousness test.''
