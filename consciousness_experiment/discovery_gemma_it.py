#!/usr/bin/env python3
"""
discovery_gemma_it.py

Feature discovery using Gemma-2B-IT (instruction-tuned).
Should engage better with philosophical prompts than base model.
"""
...
class PromptActivation:
    ...
    model_completion: str  # Also capture what the model says
...
def print_report(analysis: Dict[str, Any]) -> None:
    print("\n" + "=" * 70)
    print("GEMMA-2B-IT CONSCIOUSNESS FEATURE DISCOVERY REPORT")
    print("=" * 70)
...
def main():
    ...
    results = run_discovery(prompts=prompts, device=args.device)
